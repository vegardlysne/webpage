...
tribble(
   ...
   2019, "The conference of the Norwegian Associations of Clinical Dietitians (KEFF), Bergen, Norway", "",
   2018, "The conference of the Norwegian Associations of Clinical Dietitians (KEFF), Kristiansand, Norway", "",
   2017, "The conference of the Norwegian Associations of Clinical Dietitians (KEFF), Oslo, Norway", "Oral presentation",
   2015, "The conference of the Norwegian Associations of Clinical Dietitians (KEFF), Oslo, Norway", "",
   2013, "The conference of the Norwegian Associations of Clinical Dietitians (KEFF), Oslo, Norway", "",
   2012, "The conference of the Norwegian Associations of Clinical Dietitians (KEFF), Oslo, Norway", "",
) %>% 
  arrange(desc(Year)) %>% 
...
tribble(
   ~ Year, ~ Role, 
   "2019", "Leader of Organizing comittee of the annual conference of The Norwegian Association of Dietitians",
...
tribble(
  ...
  "Per Magne Ueland", "Email: per.ueland@ikb.uib.no, Tel: (+47) 55973147", "Bevital A/S") %>% 
