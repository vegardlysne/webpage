...
When analyzing the association between an exposure and an outcome, we can condition on (i.e. adjust for) other variables. The purpose of conditioning is to keep the value of these variables “fixed” in the model. Depending on which variables we condition on, a different interpretation of the observed association is warranted. 
